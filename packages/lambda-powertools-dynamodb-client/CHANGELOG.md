...
**Note:** Version bump only for package @kmihaltsov/lambda-powertools-dynamodb-client
...
**Note:** Version bump only for package @kmihaltsov/lambda-powertools-lambda-client
